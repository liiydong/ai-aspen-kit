# -*- coding: utf-8 -*-
"""S1：扩展「汽提/脱色/三效蒸发/结晶/离心/干燥/泵」——10 个新模块"""
...
OUT = r'D:\<化工工作区>\NA-Chemical-10000t_s1.bkp'
...
# 2) 重接既有流股
t = set_in(t, 'E-601', '"S-203" M0-1')          # 一效蒸发改由脱色滤液进料
t = set_in(t, 'T-401', '"S-114A" M0-1')         # 经 P-301 加压后进脱甲苯塔
t = set_in(t, 'T-402', '"S-116A" M0-1')         # 经 P-401 加压后进脱轻塔
print('2) E-601 / T-401 / T-402 重接 ✓')
...
ins = (ent('T-302', 'RADFRAC', 'RadFrac', '"S-113" M0-1', '"S-212" M1-2 "S-213" M2-3')
       ...
       + ent('E-602', 'FLASH2', 'Flash2', '"S-204" M0-1', '"S-402" M1-2 "S-205" M0-1')
...
T302 = ('? BLOCK RADFRAC "T-302" ? ; "METCBAR_MOLE" ; ; ABSBR1 ; \\ PARAM NSTAGE = 8 NSTAGEMAX = 9 \\ \\ '
        ...
        'FEEDS FEED-SID = "S-113" FEED-STAGE = 4 \\ \\ '
...
print()
print('=== 后处理段流股 ===')
for s in ['S-201', 'S-202', 'S-203', 'S-204', 'S-205', 'S-206', 'S-207', 'S-208', 'S-209',
          'S-211', 'S-212', 'S-213', 'S-401', 'S-402', 'S-403', 'S-404', 'S-405', 'S-406',
          'S-114', 'S-114A', 'S-116', 'S-116A', 'S-121']:
